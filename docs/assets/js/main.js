!(function(e) {
         ...
         */ !(function() {
            ...
            (C.version = '2.3.9'),
                ...
                (C.FieldRef.prototype.toString = function() {
                    return (
                        null == this._stringValue && (this._stringValue = this.fieldName + C.FieldRef.joiner + this.docRef),
                        this._stringValue
                    );
                }),
                /*!
                ...
                (C.Pipeline.registerFunction = function(e, t) {
                    t in this.registeredFunctions && C.utils.warn('Overwriting existing registered function: ' + t),
                        (e.label = t),
                ...
                (C.Vector.prototype.dot = function(e) {
                    for (
                        var t = 0, r = this.elements, n = e.elements, i = r.length, s = n.length, o = 0, a = 0, u = 0, l = 0;
                        u < i && l < s;

                    )
                        (o = r[u]) < (a = n[l]) ? (u += 2) : o > a ? (l += 2) : o == a && ((t += r[u + 1] * n[l + 1]), (u += 2), (l += 2));
                    return t;
                }),
                 ...
                 */ (C.stemmer =
                    ...
                    (_ = function(e) {
                        ...
                        return (
                            ...
                            (i = b).test(e) && ((t = (_ = i.exec(e))[1]), (r = _[2]), (i = c).test(t) && (e = t + o[r])),
                            (i = S).test(e) && ((t = (_ = i.exec(e))[1]), (r = _[2]), (i = c).test(t) && (e = t + a[r])),
                            (s = Q),
                            (i = k).test(e)
                                ? ((t = (_ = i.exec(e))[1]), (i = h).test(t) && (e = t))
                                : s.test(e) && ((t = (_ = s.exec(e))[1] + _[2]), (s = h).test(t) && (e = t)),
                            (i = O).test(e) &&
                                ((t = (_ = i.exec(e))[1]), (s = d), (u = T), ((i = h).test(t) || (s.test(t) && !u.test(t))) && (e = t)),
                            (s = h),
                ...
                (C.TokenSet.fromFuzzyString = function(e, t) {
                    for (var r = new C.TokenSet(), n = [{node: r, editsRemaining: t, str: e}]; n.length; ) {
                        ...
                        if (i.str.length > 0) {
                            var s,
                                o = i.str.charAt(0);
                            o in i.node.edges ? (s = i.node.edges[o]) : ((s = new C.TokenSet()), (i.node.edges[o] = s)),
                        ...
                        if (0 != i.editsRemaining) {
                            ...
                            if (i.str.length > 1) {
                                var l,
                                    c = i.str.charAt(0),
                                    h = i.str.charAt(1);
                                h in i.node.edges ? (l = i.node.edges[h]) : ((l = new C.TokenSet()), (i.node.edges[h] = l)),
                ...
                (C.TokenSet.prototype.intersect = function(e) {
                    for (var t = new C.TokenSet(), r = void 0, n = [{qNode: e, output: t, node: this}]; n.length; ) {
                        r = n.pop();
                        for (
                ...
                (C.Builder.prototype.createFieldVectors = function() {
                    for (var e = {}, t = Object.keys(this.fieldTermFrequencies), r = t.length, n = Object.create(null), i = 0; i < r; i++) {
                        for (
                            ...
                            void 0 === n[g] ? ((y = C.idf(this.invertedIndex[g], this.documentCount)), (n[g] = y)) : (y = n[g]),
                                (m =
                                    (y * ((this._k1 + 1) * x)) /
                ...
                (C.Query.prototype.clause = function(e) {
                    return (
                        ...
                        e.wildcard & C.Query.wildcard.LEADING && e.term.charAt(0) != C.Query.wildcard && (e.term = '*' + e.term),
                        e.wildcard & C.Query.wildcard.TRAILING && e.term.slice(-1) != C.Query.wildcard && (e.term = e.term + '*'),
                ...
                (C.Query.prototype.isNegated = function() {
                    for (var e = 0; e < this.clauses.length; e++) if (this.clauses[e].presence != C.Query.presence.PROHIBITED) return !1;
                    return !0;
                }),
    ...
    function(e, t, r) {
                ...
                return (
                    ...
                    (e.prototype.removeEventListener = function(e, t) {
                        if (e in this.listeners)
                            for (var r = this.listeners[e], n = 0, i = r.length; n < i; n++) if (r[n] === t) return void r.splice(n, 1);
                    }),
        ...
        document.documentElement.classList.add(P ? 'is-mobile' : 'not-mobile'),
            P && 'ontouchstart' in document.documentElement && (!0, (L = 'touchstart'), (E = 'touchmove'), (b = 'touchend')),
